        ...
        <div class="row sub_content">
            <div class="col-lg-6 col-sm-6">
                <div class="dividerHeading">
                    <h4><span>Form Pembeli Barang Bekas</span></h4>
                </div>
                <form id="beliform" method="post" name="beliform" action="">
                    ...
                    <div class="form-group">
                        <input type="submit" class="btn btn-default btn-lg button" value="Kirim">
                    </div>
                </form>
            </div>
        </div>
