            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="page_title">
                        <h2>Form Penjualan Barang Bekas</h2>
                    </div>
                    <nav id="breadcrumbs">
                        <ul>
        ...
        <div class="row sub_content">
            <div class="col-lg-6 col-sm-6">
                <div class="dividerHeading">
                    <h4><span>Form Penjualan</span></h4>
                </div>
                <form id="jualform" method="post" name="jualform" action="">
                    ...
                    <div class="form-group">
                        <input type="email" class="form-control" placeholder="Nama Penjual">
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-control" placeholder="CP Penjual">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Alamat Penjual">
                    </div>
                    <div class="form-group">
                        <input type="submit" class="btn btn-default btn-lg button" value="Upload">
                    </div>
                </form>
            </div>
        </div>
