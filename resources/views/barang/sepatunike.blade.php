						...
						<div class="blog_single">
							<article class="post">
								...
								<div class="post_content" style="font-size:15px;">
									...
									<p>Sepatu nike adalah salah satu jenis sepatu dari brand ternama yang kepopulerannya tak perlu diragukan lagi. Nike, brand ternama tersebut, adalah perusahaan yang membawahi berbagai produk olahraga seperti pakaian, alat olahraga, hingga sepatu. Brand ini telah tersohor di seluruh penjuru dunia. Selain karena kualitasnya yang baik, brand ini juga banyak melakukan manuver-manuver cerdik.</p>

									<p><ol><li>Kualitas tak diragukan lagi</li>
									<li>Meningkatkan performa</li>
									<li>Meningkatkan rasa percaya diri</li>
									<li>Teknoligi terbaik</li>
									<li>Resiko mendapat sepatu KW</li>
									<li>Harga mahal</li></ol></p>
